...
// Объём и затраты — продаваемые, а не выбранные в таблице: предупреждение об
// убытке должно называть число того ордера, который действительно уйдёт.
ok(/sellStopInline\('\$\{pair\}','\$\{sellNow\}','\$\{coin\}',\$\{sellNowCost\}\)/.test(d),
